 ...
 */
export class MoveAllPlayersTimerTableHandle<TableName extends string>
	implements __TableHandle<TableName>
{
	// phantom type to track the table name
	readonly tableName!: TableName;
	tableCache: __TableCache<MoveAllPlayersTimer>;

	constructor(tableCache: __TableCache<MoveAllPlayersTimer>) {
	...
	onUpdate = (
		cb: (ctx: EventContext, oldRow: MoveAllPlayersTimer, newRow: MoveAllPlayersTimer) => void
	) => {
		return this.tableCache.onUpdate(cb);
	};

	removeOnUpdate = (
		cb: (ctx: EventContext, onRow: MoveAllPlayersTimer, newRow: MoveAllPlayersTimer) => void
	) => {
